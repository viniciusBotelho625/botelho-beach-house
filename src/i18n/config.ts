  ...
  pt: {
    translation: {
      ...
      amenities: {
        ...
        securityDesc: "Sistema de monitoramento com câmeras de segurança externa e cerca elétrica"
      },
      photos: {
  ...
  en: {
    translation: {
      ...
      amenities: {
        ...
        securityDesc: "Monitoring system with external security cameras and electric fence"
      },
      photos: {
        title: 'Photo Gallery',
